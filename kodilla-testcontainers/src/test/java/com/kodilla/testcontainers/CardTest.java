    ...
    public GenericContainer webServer =
            new GenericContainer(
                    new ImageFromDockerfile()
                            .withFileFromClasspath("/tmp/card.html", "card.html")
                            .withDockerfileFromBuilder(builder ->
                                    builder
                                            .from("httpd:2.4")
                                            .copy("/tmp/card.html", "/usr/local/apache2/htdocs")
                                            .build()))
                    .withNetwork(network)
